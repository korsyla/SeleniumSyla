...
//		Take a screenshot
		...
		sendText(driver.findElement(By.id("first-name-box")), "Trent"); wait(1);
		sendText(driver.findElement(By.id("last-name-box")), "Alexander Arnond"); wait(1);
		selectDropdown(driver.findElement(By.id("location")), "Sample Location"); wait(1);
		click(driver.findElement(By.id("modal-save-button"))); wait(1);
		waitForVisability(driver.findElement(By.id("employeeId"))); wait(1);
		...
		//This is a flag -> which means we don't have it, soon as i have it stop/break the loop
		boolean found = false; // Found = False
		
		//While NOT found  .... go inside the while() loop
		while(!found) 
		{
